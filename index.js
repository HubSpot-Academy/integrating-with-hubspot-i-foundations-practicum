...
const PRIVATE_APP_ACCESS = 'pat-na1-b720b9a2-5eed-41f4-baba-9b6a3197fb21';

// TODO: ROUTE 1 - Create a new app.get route for the homepage to call your custom object data. Pass this data along to the front-end and create a new pug template in the views folder.

// * Code for Route 1 goes here
app.get('/', async (req, res) => {
    const characters = 'https://api.hubspot.com/crm/v3/objects/characters?properties=name,type,bio';
    const headers = {
    ...
    try {
        ...
        res.render('homepage', { title: 'Characters | Integrating With HubSpot I Practicum', data });      
    } catch (error) {
        console.error(error);
    }
});
